...
export class UpdateProfileInput {
  ...
  @IsIn(['PC', 'PS5', 'XBOX', 'SWITCH', 'MOBILE'], { each: true, message: 'Plataforma no válida' })
  platforms?: string[];
  ...
  @Field({ nullable: true })
  @IsOptional()
  @IsIn(['Casual', 'Competitivo', 'Cooperativo'], { message: 'Estilo de juego no válido' })
  styleOfPlay?: string;

  @Field(() => [String], { nullable: true })
  @IsOptional()
  @IsArray({ message: 'availability debe ser un arreglo' })
  @IsIn(['Manana', 'Tarde', 'Noche', 'Fines de semana'], { each: true, message: 'Disponibilidad no válida' })
  availability?: string[];
